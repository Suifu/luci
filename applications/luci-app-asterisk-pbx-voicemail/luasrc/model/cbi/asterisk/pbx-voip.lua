...
m = Map (modulename, translate("VoIP Trunks"),
...
provider = s:option(Value, "name",  translate("Provider Name"))
provider.default = "TIM"

num = s:option(Value, "defaultuser",  translate("Num Tel"))
num.default = "+3902123"
...
h = s:option(Value, "host", translate("SIP Server/Registrar/domain name"))
-- h.datatype = "host"
h.default = "telecomitalia.it"
