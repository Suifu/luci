...
-----------------------------------------------------------------------------
s = m:section(TypedSection, "local_user", translate("SIP Device/Softphone Accounts/List of User Extensions"))
s.anonymous = true
s.addremove = true

p = s:option(ListValue, "technology", translate("Technology:"))
p:value("sip", translate("SIP"))
p:value("iax",  translate("IAX"))
p.default = "sip"

du = s:option(Value, "fullname", translate("Full Name/Extension"),
...
canreinvite = s:option(ListValue, "canreinvite", "Reinvite/redirect media connections", "")
...
static = s:option(Flag, "static", "Static", "")
static.rmempty = true

writeprotect = s:option(Flag, "writeprotect", "Write Protect", "")
writeprotect.rmempty = true

allow = s:option(MultiValue, "allow", "Allow codecs", "")
allow:value("alaw", "alaw")
allow:value("ulaw", "ulaw")
allow:value("g711", "g711")
allow:value("g722", "g722")
allow:value("g726", "g726")
allow:value("g729", "g729")
allow.default = "alaw"
allow.rmempty = true

-- port = s:option(Value, "port", "SIP Port", "")
-- port.rmempty = true

-- realm = s:option(Value, "realm", "SIP realm", "")
-- realm.rmempty = true
